...
@dataclass
class AgentMP(ActorCriticBase):
    def __post_init__(self):
        super().__post_init__()
        self.algo_multi_cfg = self.cfg.task.multi.MP
        self.obs_dim = list(self.cfg.task.multi.MP.single_agent_obs_dim)
        self.action_dim = int(self.cfg.task.multi.MP.single_agent_action_dim)
        ...
        self.symmetry_manager = SymmetryManager(self.cfg.task.multi.MP, self.cfg.task.symmetry.symmetric_envs)
